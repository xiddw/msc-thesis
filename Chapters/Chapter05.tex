...
Como se observa en la \autoref{fig:sig_silence} basta entonces con eliminar los segmentos que mayormente son silencios y reagrupar la señal restante.

Con esto, se obtiene una señal en general más pequeña, y que se podría  considerar solo contiene realmente los datos que se desea modelar.
