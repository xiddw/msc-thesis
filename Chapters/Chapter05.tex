...
\begin{comment}
Este problema se puede abordar de diferentes maneras, y en el presente 
trabajo se tratará utilizando HMM y EM.
\end{comment}
...
Es de gran ayuda para la tarea de reconocimiento de voz, puesto que 
...
Se considera que se tiene una señal digital de voz, y que a partir 
...
\graffito{Nota: Tanto en ancho de la ventana, como el umbral para definir 
si será silencio se pueden ajustar dependiendo del tipo de señal.}
...
\begin{figure}[bth]
        ...
        {\includegraphics[width=0.9\linewidth]{gfx/silence1}} \quad

        \subfloat[Señal procesada y recortada.]
        {\includegraphics[width=0.9\linewidth]{gfx/silence2}} \quad
...
Para la tarea de \sd, se usarán los Coeficientes Cepstrales de Frecuencia 
