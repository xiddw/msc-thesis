...
En el trabajo de \cite{Wooters2007}, también proponen una métrica basada en BIC para la aglomeración de los grupos, pero se enfocan principalmente en mejorar una etapa de pre-procesamiento de la señal para detectar cuando alguien o no habla en la grabación.

Por otro lado, en el trabajo de \cite{Nguyen2009} se menciona 
